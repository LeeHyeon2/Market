...
<div class="container">
    ...
    <form action="/board/update" method="post" name="updateForm" enctype="multipart/form-data">
        <table class="table table-border">
            ...
            <tr>
                <th>제목(필수)</th>
                <td><input type="text" name="boardTitle" id="boardTitle" value="${boardDTO.boardTitle}"></td>
            </tr>
            <tr>
                <th>내용(필수)</th>
                <td><textarea name="boardContents" id="boardContents" cols="50" rows="10">${boardDTO.boardContents}</textarea></td>
            </tr>
            <tr>
                <th>거래 가격(필수)</th>
                <td><input type="text" name="boardPrice" id="boardPrice" value="${boardDTO.boardPrice}">(원)</td>
            </tr>
            <tr>
                <th>희망 거래지역(필수)</th>
                <td>
            ...
            <tr>
                <td><input style="border: #dde0e3; background-color: #dde0e3; color: black;" class="btn btn-primary" type="button" onclick="update()" value="수정완료"></td>
                <td></td>
            </tr>
        </table>
    </form>
